            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <button class="btn btn-success" id="tambah-admin" data-bs-toggle="modal" data-bs-target="#tambah-data-admin">
                            Tambah Admin
                        </button>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Cari Data Admin" id="cari-admin">
                            <button class="btn btn-success" type="button" id="cari-admin">Cari</button>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="tambah-data-admin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambahkan Data Admin</h5>
