    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 mr-auto mt-5 pt-5 col-md-6 col-12 newsletter-form">
                <h4 data-aos="fade-up" data-aos-delay="200">Lapor-in | Masuk</h4>

                <h2 data-aos="fade-up" data-aos-delay="300">Masuk untuk memulai sesi.</h2>
                ...
                <small class="form-text mt-4" data-aos="fade-up" data-aos-delay="700"><a href="<?= base_url('Authentication/daftar') ?>">Daftar akun baru!</a></small>
